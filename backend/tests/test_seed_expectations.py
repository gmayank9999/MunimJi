...
CASES = [
    ...
    ("INV-1031", "CLOSE", "R03", dict(client_tier="VIP", paypal_status="PAID", amount_inr=15000, due_inr=0), {}),
    ("INV-1034", "CLOSE", "R03", dict(client_tier="Regular", paypal_status="PAID", amount_inr=12000, due_inr=0), {}),
    (
        "INV-1038", "WAIT", "R14",
        dict(client_tier="New", paypal_status="SENT", amount_inr=18000, due_inr=18000, days_overdue=0),
        {},
    ),
    (
        "INV-1042", "WAIT", "R15",
        dict(client_tier="New", paypal_status="SENT", amount_inr=8000, due_inr=8000, days_overdue=1),
        {},
    ),
    (
        "INV-1049", "HIGH_PRIORITY", "R19",
        dict(
            client_tier="VIP", paypal_status="SENT", amount_inr=40000, due_inr=40000,
    ...
    (
        "INV-1053", "WAIT", "R09",
        dict(
            client_tier="Regular", paypal_status="SENT", amount_inr=26000, due_inr=26000,
    ...
    (
        ...
        dict(
            client_tier="Watchlist", paypal_status="SENT", amount_inr=35000, due_inr=35000,
    ...
    (
        ...
        dict(
            client_tier="VIP", paypal_status="SENT", amount_inr=30000, due_inr=30000, paid_inr=0,
    ...
    (
        ...
        dict(client_tier="Regular", paypal_status="SENT", amount_inr=22000, due_inr=22000, days_overdue=5),
        {},
    ),
    (
        "INV-1066", "WAIT", "R12",
        dict(
            client_tier="New", paypal_status="SENT", amount_inr=14000, due_inr=14000,
    ...
    (
        ...
        dict(
            client_tier="VIP", paypal_status="PAID", amount_inr=60000, due_inr=0,
    ...
    (
        "INV-1072", "WAIT", "R16",
        dict(
            client_tier="Watchlist", paypal_status="SENT", amount_inr=9000, due_inr=9000,
    ...
    (
        ...
        dict(
            client_tier="Regular", paypal_status="SENT", amount_inr=48000, due_inr=48000,
    ...
    (
        ...
        dict(
            client_tier="Regular", paypal_status="SENT", amount_inr=85000, due_inr=85000,
    ...
    (
        ...
        dict(
            client_tier="Regular", paypal_status="SENT", amount_inr=180000, due_inr=180000,
    ...
    (
        ...
        dict(
            client_tier="New", paypal_status="PAID", amount_inr=4000, due_inr=0, paid_inr=4000,
            days_overdue=12,
        ),
    ...
    (
        ...
        dict(
            client_tier="Watchlist", paypal_status="SENT", amount_inr=27000, due_inr=27000,
    ...
    (
        ...
        dict(client_tier="VIP", paypal_status="SENT", amount_inr=22000, due_inr=22000, days_overdue=3),
        {},
    ),
]
